          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            <div className="py-12 md:py-20">
              ...
              <div className="grid grid-cols-1 gap-14 max-w-sm md:max-w-4xl mx-auto gap-x-3 px-5 md:px-20">
                <div className="sponsor gap-14 text-gray-600 flex flex-col md:flex-row items-center justify-center md:col-auto"><div className="md:w-1/2 content-center"><img src={require('../../images/sponsors/nasa.png').default} alt="apple-logo.png" /></div><div className="md:w-1/2">The National Aeronautics and Space Administration is an independent agency of the United States Federal Government responsible for the civilian space program, as well as aeronautics and aerospace research. We received the NASA FRC grant this year totaling $4,000.</div></div>
                ...
                <div className="sponsor gap-14 text-gray-600 flex flex-col md:flex-row items-center justify-center md:col-auto"><div className="md:w-1/2 content-center"><img src={require('../../images/sponsors/steel.jpeg').default} alt="apple-logo.png" /></div><div className="md:w-1/2">Pleasanton Steel and Supply with retail steel sales, custom fabrication, and repair services. They have provided us with free and discounted stock material and shown us their fabrication facilities.</div></div>
                ...
                <div className="sponsor gap-14 text-gray-600 flex flex-col md:flex-row items-center justify-center md:col-auto"><div className="md:w-1/2 content-center"><img src={require('../../images/sponsors/apple-logo.png').default} alt="apple-logo.png" /></div><div className="md:w-1/2">Apple Inc. is an American multinational technology company headquartered in Cupertino, California, that designs, develops, and sells consumer electronics, computer software, and online services. We are proud to have received the $6000 Apple FRC grant this season and to work with two technical mentors with Apple experience.</div></div>
