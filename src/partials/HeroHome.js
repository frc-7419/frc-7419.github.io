...
function HeroHome() {
  ...
  return (
    <section className="relative">
      ...
      <div className="bg-black mx-auto w-full absolute mt-14 md:mt-20"> <img className="opacity-40 " src={require('../images/7419TechSupport.jpg').default}alt="Hero" /> </div>
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              <div className="flex flex-col justify-center">
                <img className="mx-auto w-1/2 rounded-xl" src={require('../images/2020Robot.png').default} width="768" height="432" alt="Hero" />
              </div>
