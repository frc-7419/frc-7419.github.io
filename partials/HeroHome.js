...
function HeroHome() {
  ...
  return (
    <section className="relative">
      ...
      <div className="bg-black mx-auto w-full absolute mt-14 md:mt-20"><img className="opacity-40 object-fill w-full" src='/static/images/7419TechSupport.jpg' alt="Hero" /> </div>
      {/* <div className="bg-black mx-auto w-full absolute mt-14 md:mt-20"><img className="opacity-40 object-fill w-full" src='/static/images/madtown_team.jpg' alt="Hero" /> </div> */}
