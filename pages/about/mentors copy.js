          ...
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
              ...
              <p className="text-xl text-gray-600" data-aos="zoom-y-out">
                Meet the adults supporting us on our mission.
              </p>
            </div>
            ...
            <div className="max-w-sm md:max-w-4xl mx-auto grid gap-1 grid-cols-3 md:grid-cols-3">
              <div className="mentor flex items-center justify-center py-2 col-span-2 md:col-auto">
                <img
                  ...
                  src="/static/images/mentors/ainsley.jpeg"
                  alt="Ainsley Laing"
                  width="225px"
                />
              ...
              <div className="mentor flex items-center justify-center py-2 col-span-2 md:col-auto">
                <img
                  className="rounded-full"
                  src="/static/images/mentors/leon.jpg"
                  alt="Leon Cox"
                  width="225px"
                />
              ...
              <div className="mentor flex items-center justify-center py-2 col-span-2 md:col-auto">
                <img
                  className="rounded-full"
                  src="/static/images/mentors/richard.jpg"
                  alt="Richard Ong"
                  width="225px"
                />
                ...
                <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
                  <div className="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                    ...
                    <img
                      ...
                      src="/static/images/testimonial.jpg"
                      width="96"
                      height="96"
                      alt="Testimonial 01"
                    />
