          ...
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
              ...
              <p className="text-xl text-gray-600" data-aos="zoom-y-out">
                We inspire excitement for STEM and FIRST in our own community,
                and to help make FIRST programs successful and accessible to
                others.
              </p>
            </div>
              ...
              <ul>
                <li className="mb-3">
                  ...
                  <p className="text-gray-600 mb-4 max-w-full ">
                    During this week, we donated to shelters, sent letters to
                    healthcare workers, and 3D printed toys. As a team that is
                    part of the FRC community, we not only learn about STEM, but
                    also recognize how crucial it is to help others and give
                    back to those who made sacrifices during the pandemic to
                    assist the sick.
                  </p>
                  <div className="grid grid-cols-2 gap-2">
                    <img
                      ...
                      style={{ height: 400 }}
                      src="/static/images/outreach/2021_kindness_week/letters.jpg"
                      alt="Letters"
                    />
                    <img
                      className="rounded mb-4 mx-auto max-w-sm md:max-w-md xl:max-w-xl w-full object-cover"
                      style={{ height: 400 }}
                      src="/static/images/outreach/2021_kindness_week/toilet_paper.png"
                      alt="Toilet Paper"
                    />
                  </div>
                </li>
                <li>
                  <div>
                    ...
                    <img
                      className="rounded mb-4 mx-auto max-w-sm md:max-w-md xl:max-w-xl w-full object-cover"
                      style={{ height: 400 }}
                      src="/static/images/outreach/fll.jpg"
                      alt="FLL Tournament"
                    />
                  </div>
                </li>
                    ...
                    <ul>
                      <li className="mb-3">
                        <p className="text-gray-600">
                          It is an after-school enrichment program to present
                          scientific and engineering concepts to young children
                          in a captivating manner to open their eyes to the
                          possibilities right at their fingertips! Our hope is
                          that they are not only left with a little more
                          technological intuition than an hour ago but are
                          curious about the ingenious culture of FIRST robotics
                          that our members come from. Our hope is that they are
                          not only left with a little more technological
                          intuition than an hour ago but are curious about the
                          ingenious culture of FIRST robotics that our members
                          come from.
                        </p>
                      </li>
                    </ul>
